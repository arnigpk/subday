  ...
  try {
    ...
    if (text === '/start' || text.startsWith('/start ') || text === '/login') {
      ...
      await sendTelegramMessage(
        ...
        'HTML',
        // Кнопка в сообщении открывает Mini App (как и раньше). Пробовали заменить
        // на обычную ссылку с автологином — Telegram открывал её во внешнем браузере
        // вместо приложения, поэтому вернули рабочий вариант.
