    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <ul className="list-disc list-inside ml-4 space-y-1">
          ...
          <li>«15 кофе / 15 дней» — 15 Погашений, срок действия 15 календарных дней;</li>
      ...
      <div className="space-y-2">
        <h4 className="font-semibold text-foreground">7. Гостевой доступ (1 раз на аккаунт, срок 10 дней)</h4>
        <p>7.1. Пользователь может один раз на один аккаунт предоставить третьему лицу (18+) гостевой доступ.</p>
        <p>7.2. Гостевой доступ действует 10 (десять) календарных дней с момента выдачи.</p>
      ...
      <div className="space-y-2">
        <h4 className="font-semibold text-foreground">7bis. Пользовательский контент в #subFlow и правила сообщества</h4>
        <p>7bis.1. Раздел #subFlow позволяет Пользователям публиковать контент (посты, истории, комментарии, реакции). Публикуя контент, Пользователь подтверждает, что имеет на это право и несёт за него полную ответственность.</p>
        <p>7bis.2. Действует политика <strong>НУЛЕВОЙ ТЕРПИМОСТИ</strong> к оскорбительному, непристойному, дискриминационному, незаконному, вводящему в заблуждение контенту, а также к спаму, домогательствам и любому абьюзивному поведению по отношению к другим пользователям. Такой контент и такое поведение <strong>строго запрещены</strong>.</p>
        <p>7bis.3. Пользователю доступны инструменты модерации: <strong>«Пожаловаться»</strong> на любой контент и <strong>«Заблокировать пользователя»</strong>. Заблокированный пользователь и его контент мгновенно исчезают из ленты пожаловавшегося.</p>
        <p>7bis.4. Оператор рассматривает жалобы и удаляет нарушающий контент, а также блокирует нарушителей <strong>в течение 24 часов</strong> с момента получения жалобы.</p>
        <p>7bis.5. Продолжая использовать #subFlow, Пользователь соглашается с настоящими правилами и подтверждает, что не будет публиковать запрещённый контент. Нарушение правил влечёт удаление контента и блокировку аккаунта.</p>
      </div>
...
function UserAgreementContent() {
  return (
    <>
      ...
      <div className="space-y-1 text-xs">
        <p><strong>Дата размещения:</strong> 28 января 2026 г.</p>
        <p><strong>Оператор:</strong> ТОО "Subday Group", БИН 260240030635, supp@subday.app, +7 707 700 0994</p>
      </div>
...
function PrivacyPolicyContent() {
  return (
    <>
      ...
      <div className="space-y-1 text-xs">
        <p><strong>Дата размещения:</strong> 28 января 2026 г.</p>
        <p><strong>Оператор персональных данных:</strong> ТОО "Subday Group", БИН 260240030635</p>
      ...
      <div className="mt-6 pt-4 border-t space-y-4">
        ...
        <p>Я даю ТОО "Subday Group", БИН 260240030635, согласие на сбор, хранение, обработку и передачу моих персональных данных в объёме и целях, указанных в Политике конфиденциальности Subday, включая регистрацию, проведение оплат, учёт Пакетов/Погашений, гостевой доступ, поддержку, безопасность и антифрод.</p>
