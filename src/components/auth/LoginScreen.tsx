        ...
        <div className="w-full max-w-sm space-y-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          {step === 'phone' ? (
            <>
              ...
              {channel === 'whatsapp' && (
                <p className="text-sm text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/30 p-3 rounded-lg text-center">
                  WhatsApp временно не работает, используйте пожалуйста SMS-код, или Telegram для входа
                </p>
              )}
              {channel === 'sms' && (
