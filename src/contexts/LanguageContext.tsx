...
const translations: Record<string, Record<Language, string>> = {
  ...
  'auth.guestBrowse': { ru: 'Продолжить без регистрации', kz: 'Тіркелмей жалғастыру', en: 'Continue without registration', uz: 'Roʻyxatdan oʻtmasdan davom etish', kg: 'Каттоосуз улантуу' },
