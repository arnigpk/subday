...
const translations: Record<string, Record<Language, string>> = {
  ...
  'profile.notificationsNotSupported': { ru: 'Уведомления не поддерживаются на этом устройстве', kz: 'Бұл құрылғыда хабарламалар қолдамайды', en: 'Notifications are not supported on this device', uz: 'Bu qurilmada bildirishnomalar qo\'llab-quvvatlanmaydi', kg: 'Бул түзмөктө билдирүүлөр колдоолбойт' },
  'profile.notificationsDenied': { ru: 'Разрешение на уведомления отклонено. Измените в настройках устройства.', kz: 'Хабарламаларға рұқсат қабылданбады. Құрылғы параметрлерінде өзгертіңіз.', en: 'Notification permission denied. Change in device settings.', uz: 'Bildirishnoma ruxsati rad etildi. Qurilma sozlamalarida o\'zgartiring.', kg: 'Билдирүү уруксаты четке кагылды. Түзмөк жөндөөлөрүнөн өзгөртүңүз.' },
  ...
  'auth.guestBrowse': { ru: 'Продолжить как гость', kz: 'Қонақ ретінде жалғастыру', en: 'Continue as guest', uz: 'Mehmon sifatida davom etish', kg: 'Конок катары улантуу' },
  'auth.agreeCheckbox': { ru: 'Я принимаю', kz: 'Мен қабылдаймын', en: 'I accept the', uz: 'Men qabul qilaman', kg: 'Мен кабыл алам' },
  'auth.agreeCheckboxLink': { ru: 'правила сервиса', kz: 'сервис ережелерін', en: 'terms of service', uz: 'xizmat qoidalarini', kg: 'кызмат эрежелерин' },
  'auth.loginToContinue': { ru: 'Войдите или зарегистрируйтесь, чтобы продолжить', kz: 'Жалғастыру үшін кіріңіз немесе тіркеліңіз', en: 'Sign in or register to continue', uz: 'Davom etish uchun kiring yoki roʻyxatdan oʻting', kg: 'Улантуу үчүн кириңиз же катталыңыз' },
  'auth.guestBanner': { ru: 'Вы просматриваете как гость', kz: 'Сіз қонақ ретінде қарап отырсыз', en: 'You are browsing as a guest', uz: 'Siz mehmon sifatida koʻrmoqdasiz', kg: 'Сиз конок катары карап жатасыз' },
  'auth.loginRegister': { ru: 'Войти', kz: 'Кіру', en: 'Sign in', uz: 'Kirish', kg: 'Кирүү' },
  'auth.smsCode': { ru: 'Код из SMS', kz: 'SMS коды', en: 'SMS code', uz: 'SMS kod', kg: 'SMS код' },
  'auth.whatsappCode': { ru: 'Код из WhatsApp', kz: 'WhatsApp коды', en: 'WhatsApp code', uz: 'WhatsApp kod', kg: 'WhatsApp код' },
  ...
  'guest.giftTitle': { ru: 'Гостевой кофе', kz: 'Қонақ кофе', en: 'Guest coffee', uz: 'Mehmon kofe', kg: 'Конок кофе' },
  'guest.giftSubtitle': { ru: 'Подари кофе другу, пригласи в приложение', kz: 'Досыңа кофе сыйла, қолданбаға шақыр', en: 'Gift coffee to a friend, invite to the app', uz: 'Do\'stingizga qahva sovg\'a qiling, ilovaga taklif qiling', kg: 'Досуңузга кофе белек кылыңыз, колдонмого чакырыңыз' },
  ...
  'guest.successMessage': { ru: 'Готово! Друг получил 1 кофе ☕️\nСписание с вашей подписки выполнено.', kz: 'Дайын! Досыңыз 1 кофе алды ☕️\nЖазылымыңыздан есептелді.', en: 'Done! Friend got 1 coffee ☕️\nDeducted from your plan.', uz: 'Tayyor! Do\'stingiz 1 qahva oldi ☕️\nObunangizdan hisobdan chiqarildi.', kg: 'Даяр! Досуңуз 1 кофе алды ☕️\nЖазылууңуздан эсептелди.' },
  'guest.pendingMessage': { ru: 'Приглашение отправлено ✅\nКак только друг зарегистрируется по этому номеру, он сразу получит 1 кофе.', kz: 'Шақыру жіберілді ✅\nДосыңыз осы нөмірмен тіркелген кезде 1 кофе алады.', en: 'Invitation sent ✅\nOnce your friend registers with this number, they\'ll get 1 coffee.', uz: 'Taklif yuborildi ✅\nDo\'stingiz bu raqam bilan ro\'yxatdan o\'tganda 1 qahva oladi.', kg: 'Чакыруу жөнөтүлдү ✅\nДосуңуз бул номер менен катталганда 1 кофе алат.' },
  'guest.giftReceived': { ru: 'Вам подарили 1 кофе ☕️', kz: 'Сізге 1 кофе сыйлады ☕️', en: 'You received 1 coffee ☕️', uz: 'Sizga 1 qahva sovg\'a qilindi ☕️', kg: 'Сизге 1 кофе белек кылынды ☕️' },
