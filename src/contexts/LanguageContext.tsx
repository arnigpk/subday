...
const translations: Record<string, Record<Language, string>> = {
  ...
  'subflow.lockedDesc': { ru: 'Купите подписку чтобы увидеть уникальный раздел #subFlow и публиковать посты и комментарии.', kz: '#subFlow бөлімін көру және пост, пікір жазу үшін жазылым сатып алыңыз.', en: 'Subscribe to access the #subFlow section and post comments.', uz: '#subFlow bo\'limini ko\'rish va post, izoh yozish uchun obuna bo\'ling.', kg: '#subFlow бөлүмүн көрүү жана пост, пикир жазуу үчүн жазылуу сатып алыңыз.' },
  'subflow.newPost': { ru: 'Новый пост ✨', kz: 'Жаңа пост ✨', en: 'New post ✨', uz: 'Yangi post ✨', kg: 'Жаңы пост ✨' },
  'subflow.placeholder': { ru: 'Какой кофе сегодня? Расскажи! ☕', kz: 'Бүгін қандай кофе? Айтып беріңіз! ☕', en: 'What coffee today? Tell us! ☕', uz: 'Bugun qanday qahva? Aytib bering! ☕', kg: 'Бүгүн кандай кофе? Айтып бериңиз! ☕' },
  ...
  'auth.beelineWarning': { ru: 'Отправка смс на beeline временно недоступна по техническим причинам, используйте пожалуйста Telegram для входа.', kz: 'Beeline-ге смс жіберу техникалық себептермен уақытша қолжетімсіз, кіру үшін Telegram пайдаланыңыз.', en: 'SMS to Beeline is temporarily unavailable due to technical reasons, please use Telegram to log in.', uz: 'Beeline-ga sms yuborish texnik sabablarga ko\'ra vaqtincha mavjud emas, iltimos kirish uchun Telegram-dan foydalaning.', kg: 'Beeline-ге смс жөнөтүү техникалык себептерге байланыштуу убактылуу жеткиликсиз, кирүү үчүн Telegram колдонуңуз.' },
  'auth.viaSms': { ru: 'SMS', kz: 'SMS', en: 'SMS', uz: 'SMS', kg: 'SMS' },
  'auth.viaWhatsapp': { ru: 'WhatsApp', kz: 'WhatsApp', en: 'WhatsApp', uz: 'WhatsApp', kg: 'WhatsApp' },
  'auth.codeSentVia': { ru: 'Код отправлен через', kz: 'Код жіберілді', en: 'Code sent via', uz: 'Kod yuborildi', kg: 'Код жөнөтүлдү' },
