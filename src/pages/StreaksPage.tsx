      ...
      <AppLayout>
        <div className="safe-area-top">
          <div className="px-4 py-4 flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-foreground">Выпито</h1>
          </div>
          <div className="px-4">
      ...
      <div className="safe-area-top">
        ...
        <div className="px-4 space-y-6">
          ...
          <div className="card-static text-center animate-slide-up">
            ...
            <p className="text-muted-foreground">напитков выпито</p>
            ...
            <div className="mt-4 flex items-center justify-center gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-bold text-foreground">{stats.maxStreak} дней</p>
              </div>
            </div>
          </div>
          ...
          <div className="animate-slide-up" style={{ animationDelay: '0.1s' }}>
            <div className="flex items-center justify-between mb-2">
              <p className="text-sm font-medium text-muted-foreground">До 30 дней подряд</p>
