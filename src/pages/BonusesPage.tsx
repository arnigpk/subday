      ...
      <div className="safe-area-top">
        ...
        <div className="px-4 space-y-6">
          ...
          <div className="card-static text-center animate-slide-up bg-gradient-to-br from-yellow-500/10 to-orange-500/10">
            ...
            <p className="text-4xl font-black text-foreground mb-1">{userData.bonusPoints.toLocaleString()}</p>
            <p className="text-muted-foreground">бонусных баллов</p>
          </div>
            ...
            <div className="card-static space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">+100 за каждый напиток</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-xl">🔥</span>
                <div className="flex-1">
                  <p className="font-medium text-foreground">Держи стрик</p>
                  <p className="text-xs text-muted-foreground">+50 за каждый день подряд</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <span className="text-xl">👥</span>
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">+500 за каждого друга</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="animate-slide-up" style={{ animationDelay: '0.15s' }}>
            <h3 className="text-lg font-bold text-foreground mb-3">Обменять баллы</h3>
            <div className="space-y-3">
              {bonusRewards.map((reward) => {
                const Icon = reward.icon;
                const canRedeem = userData.bonusPoints >= reward.points;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">{reward.points.toLocaleString()} баллов</p>
                    </div>
                    ...
                    {canRedeem ? (
                      ...
                      <span className="text-xs text-muted-foreground">
                        Ещё {(reward.points - userData.bonusPoints).toLocaleString()}
                      </span>
                    )}
                  </div>
                );
